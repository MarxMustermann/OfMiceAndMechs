import src
AttrSpec = src.pseudoUrwid.AttrSpec
...
bloomShredder = (AttrSpec("#373", "black"), "%>")
...
stasisTank = (AttrSpec("#ac3", "black"), "ST")
...
bolt = (AttrSpec("#aaa", "black"), "+>")
rod = (AttrSpec("#aaa", "black"), "+|")
forceField = (AttrSpec("#334", "black"), "~~")
...
tree = (AttrSpec("#383", "black"), "oo")
infoscreen = (AttrSpec("#aaa", "black"), "iD")
blueprinter = (AttrSpec("#aaa", "black"), "SX")
productionArtwork = (AttrSpec("#ff2", "black"), "QQ")
gooflask_empty = (AttrSpec("#3f3", "black"), "o ")
gooflask_part1 = (AttrSpec("#3f3", "black"), "o.")
gooflask_part2 = (AttrSpec("#3f3", "black"), "o,")
gooflask_part3 = (AttrSpec("#3f3", "black"), "o-")
gooflask_part4 = (AttrSpec("#3f3", "black"), "o~")
gooflask_full = (AttrSpec("#3f3", "black"), "o=")
vial_empty = (AttrSpec("#f33", "black"), "o ")
vial_part1 = (AttrSpec("#f33", "black"), "o.")
vial_part2 = (AttrSpec("#f33", "black"), "o,")
vial_part3 = (AttrSpec("#f33", "black"), "o-")
vial_part4 = (AttrSpec("#f33", "black"), "o~")
vial_full = (AttrSpec("#f33", "black"), "o=")
...
wall = (AttrSpec("#778", "black"), "XX")
outer_wall = (AttrSpec((60,60,70), "black"), "XX")
dirt = (AttrSpec("#330", "black"), ".´")
grass = (AttrSpec("#030", "black"), ",`")
pipe = (AttrSpec("#337", "black"), "**")
corpse = (AttrSpec("#933", "black"), "@ ")
...
coal = "sc"
door_closed = (AttrSpec("#778", "black"), "[]")
outer_door_closed = (AttrSpec((60,60,70), "black"), "[]")
door_opened = (AttrSpec("#660", "black"), "[]")
bioDoor_closed = (AttrSpec("#030", "black"), "[]")
bioDoor_opened = (AttrSpec("#070", "black"), "[]")
pile = "UU"
acid = "~~"
notImplentedYet = "??"
floor = (AttrSpec("#444", "black"), "::")
