    ...
    def __init__(
        ...
        if not firstname:
            firstname = random.choice([
                "Ahmed","Aidan","Aiden","Aileen","Aimee","Aisha","Ajay","Alan","Alana","Alastair","Albert","Alec","Aleksandra","Alexander","Alexandra","Alexandru",
                "Alfie","Alice","Alicia","Alina","Alisha","Alistair","Allan","Allen","Allison","Aman","Amanda","Amber","Amelia","Amie","Amina","Amy","Andreea",
                "Andrei","Andreina","Andrew","Andrzej","Andy","Aneta","Angie","Angus","Ania","Anil","Anita","Ann","Annabel","Anne-Marie","Annette","Annie","Annmarie",
                "Ant","Anthony","Anton","Antonia","Antony","April","Archie","Arran","Arron","Arthur","Artur","Arun","Asad","Ashleigh","Audrey","Austin","Avril",
                "Ayesha","Ayoub","Barbara","Barrie","Barry","Bartosz","Becca","Becki","Beckie","Becky","Belinda","Bella","Ben","Benjamin","Bernadette","Bernard",
                "Beryl","Beth","Bethan","Bethany","Betty","Bev","Beverley","Bex","Bianca","Bill","Billy","Blake","Bobby","Bonnie","Boy","Brad","Bradley","Brandon",
                "Brenda","Brendan","Brett","Brian","Brice","Bridget","Brooke","Bruce","Bruno","Bryan","Bryony","Caitlin","Callum","Calum","Calvin","Cara","Carl",
                "Carla","Carlos Arturo","Carly","Carmen","Carol","Carole","Caroline","Carolyn","Carrie","Cassie","Cat","Catalin","Cath","Catherine","Cathy","Catriona",
                "Caz","Celia","Ceri","Cerys","Chantelle","Charlène","Charles","Charley","Charlotte","Charmaine","Chelsea","Cheryl","Chinenye","Chloé","Christina","Christine",
                "Christopher","Ciara","Ciaran","Cindy","Clair","Claire","Clara","Clare","Claudia","Cliff","Clinton","Clive","Colette","Colin","Colleen","Collette",
                "Conley","Connie","Connor","Conor","Corey","Corinne","Costanza","Craig","Cristian","Cristina","Crystal","Curtis","Cynthia","Daisy","Dale","Damian",
                "Damien","Damon","Dan","Daniela","Daniella","Danielle","Danni","Dariusz","Darren","Darryl","Daryl","Dave","Dawid","Dawn","Daz","Dean","Deb","Debbie",
                "Deborah","Debra","Declan","Demi","Denise","Derek","Diana","Diane","Dianne","Dionne","Dom","Dominic","Don","Donald","Donna","Doreen","Dorota","Dorothy",
                "Doug","Dougie","Douglas","Drew","Duncan","Dylan","Ebony","Ed","Edward","Eileen","Eleanor","Elisangela","Elise","Elizabeth","Ella","Elle","Ellen","Ellie",
                "Elliot","Elliott","Ellis","Eloïse","Emilia","Emily","Emma","Emmanuel","Eric","Erica","Erika","Erin","Eşref","Esther","Ethan","Euan","Eva","Evan","Eve",
                "Evelyn","Evie","Ewa","Ewan","Ewelina","Faith","Fay","Faye","Faysal","Felicity","Felix","Fernando","Finlay","Finn","Fiona","Florence","Florin","Frances",
                "Frank","Fraser","Freddie","Freya","Gabriel","Gabriela","Gabriella","Gabrielle","Gail","Gareth","Garry","Gary","Gavin","Gaynor","Gaz","Gemma","Geoff",
                "Geoffrey","George","Georgia","Georgie","Georgina","Gerald","Geraldine","Gerard","Gill","Gillian","Gina","Glen","Glenn","Gloria","Glyn","Gordon","Grace",
                "Graeme","Graham","Grant","Greg","Gregory","Grzegorz","Guy","Hamish","Hamza","Hannah","Harley","Harriet","Harrison","Harry","Hayden","Hayley","Hazel",
                "Heather","Heidi","Helder","Helen","Helena","Hellen","Henry","Hilario","Hilary","Hollie","Holly","Howard","Hugh","Hugo","Huw","Iain","Ian","Ibra",
                "Ifeanyi","Imogen","Ionut","Irene","Iris","Isaac","Isabel","Isabella","Isabelle","Ismail","Isobel","Ivan","Iwona","Jacek","Jack","Jacob","Jacqueline",
                "Jacqui","Jade","Jake","Jakub","James","Jane","Janet","Janette","Janice","Janine","Jasmin","Jasmine","Jason","Jayden","Jayne","Jeanette","Jeff","Jeffrey",
                "Jemma","Jen","Jenna","Jenni","Jennie","Jennifer","Jenny","Jeremy","Jerry","Jessica","Jill","Jim","Joanna","Joanne","Jodie","Joe","Joel","John","Johnny",
                "Jon","Jonathan","Jonny","Jorge","Josephine","Josh","Joshua","Josie","Joyce","Judith","Judy","Julia","Julian","Julie","Juliet","June","Junior","Justin",
                "Justine","Justyna","Kai","Kamil","Kamila","Kamran","Kane","Karina","Karl","Karolina","Kasia","Kat","Katarzyna","Kate","Kath","Katherine","Kathleen",
                "Kathryn","Kathy","Katie","Katrina","Katy","Kayla","Kayleigh","Keeley","Keira","Keith","Kellie","Kelsey","Kelvin","Ken","Kenneth","Kerri","Kerrie","Kev",
                "Kevin","Khaled","Kian","Kiera","Kieran","Kieron","Kimberley","Kirk","Kirsten","Kirstie","Kirsty","Kitty","Klaudia","Kristian","Kristina","Kurt","Kyle",
                "Kylie","Lana","Lara","Larry","Laura","Lauren","Lawal","Lawrence","Layla","Leah","Leanne","Leila","Lella","Lena","Leon","Leonard","Leonie","Les","Levi",
                "Lewis","Liam","Liana","Lianne","Libby","Lilly","Lily","Lina","Lindsay","Lindsey","Linzi","Lisa","Liv","Liz","Lizzie","Lizzy","Lloyd","Lois","Lola","Lorna",
                "Lorraine","Lottie","Louie","Louis","Louisa","Louise","Luca","Lucas","Lucia","Lucie","Lucy","Lukas","Lukasz","Luke","Lukman","Lydia","Lyn","Lynda","Lyndsey",
                "Lynette","Lynne","Lynsey","Maciej","Maddie","Maddy","Madeleine","Magalie","Magda","Magdalena","Maggie","Mahfoud","Maisie","Malak","Malcolm","Mandy","Manuel",
                "Marc","Marcia","Marcin","Marcus","Marek","Margaret","Mariana","Marianne","Marilyn","Marina","Mario","Marion","Marius","Mariusz","Mark","Marlene","Mart",
                "Marta","Martha","Martin","Martina","Martyn","Mary","Maryam","Mason","Mat","Mateusz","Matheo","Mathew","Matt","Matthew","Matty","Maureen","Maurice","Max",
                "Maxine","May","Mayara","Meg","Megan","Mehmet","Melanie","Melissa","Mia","Michael","Michaela","Micheal","Michelle","Mick","Micky","Miguel","Mihaela","Mihai",
                "Mike","Mikel","Mikey","Miles","Millie","Milly","Milo","Miranda","Miriam","Mirosław","Mitch","Mitchell","Mohamed","Mohit","Moira","Mollie","Molly","Monica",
                "Monika","Morag","Murray","Myles","Nadeem","Nadia","Nadine","Nancy","Naomi","Natalia","Natalie","Natasha","Nate","Nathan","Nathaniel","Nazmi","Neal","Neil",
                "Niall","Niamh","Nichola","Nicholas","Nick","Nicki","Nicole","Nigel","Nikki","Nina","Noah","Noel","Norma","Norman","Olga","Oliver","Olivia","Ollie","Olly",
                "Oscar","Owen","Paddy","Paige","Pam","Pamela","Patricia","Patrick","Patrycja","Patryk","Paul","Paulina","Pauline","Paulo","Pawel","Pedro","Penny","Perry",
                "Pete","Peter","Phil","Philip","Philippa","Phill","Phillip","Phoebe","Piotr","Pippa","Polly","Pope","Poppy","Prince","Priya","Rachael","Rachel","Rafal",
                "Rajesh","Ralph","Ravi","Ray","Raymond","Rebecca","Rebekah","Reece","Reid","Renata","Reuben","Rhian","Rhiannon","Ria","Ricardo","Rich","Richard","Richardson",
                "Richie","Rick","Ricky","Rita","Rob","Robbie","Robert","Roberta","Roberto","Robyn","Rod","Rodney","Roger","Roisin","Roland","Roman","Ron","Ronald","Ronan",
                "Ronnie","Rory","Rosa","Rose","Rosemary","Rosie","Ross","Roxanne","Roy","Ruby","Rudolf","Russ","Russell","Ruth","Sadie","Saja","Sajid","Sally",
                "Salma","Samantha","Sammie","Sammy","Samya","Sandeep","Sandra","Sanjay","Sarah","Sathish","Scarlett","Scott","Sean","Seb","Sebastian","Selina","Serena","Sevil",
                "Seyfettin","Shane","Sharron","Shaun","Shauna","Sheena","Sheila","Shelley","Shelly","Shirley","Shona","Si","Sian","Sid","Silvia","Simon","Simona","Sinead",
                "Siobhan","Skye","Sofia","Sonia","Sonny","Sonya","Sophia","Sophie","Spencer","Stan","Stanley","Ste","Stefan","Stephanie","Stephen","Steve","Steven","Stevie",
                "Stewart","Stu","Stuart","Sue","Summer","Sunil","Susan","Susie","Suzanne","Suzie","Suzy","Syed","Sylvia","Sylvie","Sylwia","Tahir","Tamara","Tammy","Tania",
                "Tanya","Tariq","Tasha","Ted","Terence","Teresa","Terezinha","Terri","Tessa","Theo","Theresa","Thomas","Tia","Tiffany","Tilly","Tim","Timothy","Tina","Tiziana",
                "Toby","Tom","Tomas","Tomasz","Tomislav","Tommy","Tony","Tori","Tracey","Trevor","Tricia","Trisha","Tristan","Troy","Trudy","Tunahan","Tunde","Tyrone","Valerie",
                "Vanessa","Vasile","Vera","Veronica","Vicki","Vickie","Victor","Victoria","Vijay","Vikki","Vince","Vincent","Viv","Vivienne","Wall","Walter","Warren","Wayne",
                "Wendy","Wesley","Will","William","Yasmin","Yukihiro","Yusuf","Yvette","Yvonne","Zac","Zach","Zack","Zain","Zak","Zara",
            ])
...
press any other key to attack normally""")
    ...
    def changed(self, tag="default", info=None):
        ...
        if tag == "changedTerrain":
            ...
            self.increase_stat_counter("terrain changes")
