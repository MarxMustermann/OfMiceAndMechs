    ...
    for (godId,god) in src.gamestate.gamestate.gods.items():
        if ( (god["lastHeartPos"][0] != god["home"][0]) or
            ...
            for _i in range(numSpectres):
                ...
                quest = src.quests.questMap["DelveDungeon"](targetTerrain=(terrain.xPosition,terrain.yPosition,0),itemID=godId,suicidal=True,directSendback=True)
    ...
    for i in range(random.randint(2,6)):
        ...
        if make_room:
            ...
            if random.random() < 0.8:
                ...
                # add functional room
                item_type = random.choice(["SwordSharpener","ArmorReinforcer","MetalWorkingBench","CoalBurner","CorpseShredder"])
