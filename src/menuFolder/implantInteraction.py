...
"""]
            ...
            for room in terrain.rooms:
                ...
                if room.tag == "manufacturingHall":
                    ...
                    continue
                if room.tag == "wallManufacturing":
                    hasWallManufacturing = True
                    continue
                ...
                if room.tag == "trapMaterialsManufacturing":
                    ...
                    continue
                if room.tag == "scrapCompactor":
                    hasScrapCompactor = True
                    continue
            ...
            if hasEmptyRoom and hasCityPlaner:
                ...
                extraDescriptions["scrapCompactor"] = "Converts Scrap to MetalBars"
                if not hasStorage:
                    available_roomTypes.append("storage")
                if not hasManufacturingHall:
                    available_roomTypes.append("manufacturingHall")
                if not hasWallManufacturing:
                    available_roomTypes.append("wallManufacturing")
                ...
                if not hasScrapCompactor:
                    available_roomTypes.append("scrapCompactor")
