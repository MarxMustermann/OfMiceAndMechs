    ...
    def getNextStep(self,character):
        ...
        if character.getTerrain().yPosition > self.targetTerrain[1]:
            if not character.getBigPosition() in ((7,1,0),(7,0,0)):
                ...
                return ([quest],None)
            if not character.getPosition() == (7*15+7,15*1+1,0) and not character.getBigPosition() in ((7,0,0),):
        ...
        if character.getTerrain().yPosition < self.targetTerrain[1]:
            if not character.getBigPosition() in ((7,13,0),(7,14,0)):
                ...
                return ([quest],None)
            if not character.getPosition() == (7*15+7,15*13+13,0) and not character.getBigPosition() in ((7,14,0),):
        ...
        if character.getTerrain().xPosition > self.targetTerrain[0]:
            if not character.getBigPosition() in ((1,7,0),(0,7,0)):
                ...
                return ([quest],None)
            if not character.getPosition() == (1*15+1,15*7+7,0) and not character.getBigPosition() in ((0,7,0),):
        ...
        if character.getTerrain().xPosition < self.targetTerrain[0]:
            if not character.getBigPosition() in ((13,7,0),(14,7,0)):
                ...
                return ([quest],None)
            if not character.getPosition() == (13*15+13,15*7+7,0) and not character.getBigPosition() in ((14,7,0),):
