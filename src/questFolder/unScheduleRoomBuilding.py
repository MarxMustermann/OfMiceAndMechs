...
class UnScheduleRoomBuilding(src.quests.MetaQuestSequence):
    '''
    quest to unschedule building a new room
    '''
    type = "UnScheduleRoomBuilding"
    def __init__(self, description="unschedule room building", creator=None, roomPosition=None,reason=None):
        questList = []
    ...
    def generateTextDescription(self):
        ...
        if self.reason:
            reason = f",\nto {self.reason}"
        text = f"""
Unschedule a room to be built on tile{reason}.
...
"""
    ...
    def handleUnScheduledRoom(self,extraParams):
        '''
    ...
    def assignToCharacter(self, character):
        ...
        self.startWatching(character,self.handleUnScheduledRoom, "unscheduled room")

        # call superclass
        return super().assignToCharacter(character)

# register quest
src.quests.addType(UnScheduleRoomBuilding)
