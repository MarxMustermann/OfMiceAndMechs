...
Since i'm a groundskeeper my duty is to maintain the premises."""])
    ...
    def builder_reset(self,builder):
        ...
        builder.duties.append("storage management")
...
I am working right now. I'll repriotize though.""")
    ...
    def builder_set_priority_trigger(self,character,partner):
        ...
        submenu = src.menues.menuMap["DutyPriorityConfigurationMenu"](character,partner)
            ...
            if quest_selection == "painter":
                ...
                if found_loot_room == False:
                    ...
                    if item_type in ("Wall","Door",):
                        amountToCollect = 5
                    quest = src.quests.questMap["Scavenge"](toCollect=item_type,amountToCollect=amountToCollect)
                    character.assignQuest(quest,active=True)
...
""")
    ...
    def setUpDesolatedLab(self,pos):
        ...
        for y in range(1,11):
            ...
            if y == 9:
                continue
            cityPlanerRoom.addWalkingSpace((6,y,0))
        ...
        for y in range(6,12):
            painterRoom.addWalkingSpace((6,y,0))
        for x in range(1,6):
        ...
        for pos in [(6,5,0),(6,4,0),(6,3,0),(7,3,0),(8,3,0),(9,4,0),(9,5,0),(9,6,0),(8,6,0),(7,6,0)]:
            painterRoom.addWalkingSpace(pos)
        ...
        for y in range(1,8):
            if y in (5,6,7,):
                anvilRoom.addWalkingSpace((5,y,0))
                anvilRoom.addWalkingSpace((7,y,0))
            if y == 6:
                continue
        ...
        for y in range(1,12):
            if y in (5,6,7,):
                metalWorkingRoom.addWalkingSpace((5,y,0))
                metalWorkingRoom.addWalkingSpace((7,y,0))
            if y == 6:
                continue
        ...
        for big_x in range(1,14):
            for big_y in range(1,14):
                ...
                if wall_was_spawned and random.random() > 0.75:
                    pos = (big_x*15+random.randint(1,13),big_y*15+random.randint(1,13),0)
...
"""),])
        ...
        resource_gethering_npc.solvers = [
                "SurviveQuest",
                "Serve",
                "NaiveMoveQuest",
                "MoveQuestMeta",
        ...
        resource_gethering_npc.flask = src.items.itemMap["GooFlask"]()
        resource_gethering_npc.flask.uses = 100
        resource_gethering_npc.faction = faction
        resource_gethering_npc.burnedIn = True

        resource_gethering_npc.duties = []
        resource_gethering_npc.registers["HOMEx"] = 7
        resource_gethering_npc.registers["HOMEy"] = 6
        resource_gethering_npc.registers["HOMETx"] = currentTerrain.xPosition
        resource_gethering_npc.registers["HOMETy"] = currentTerrain.yPosition

        resource_gethering_npc.personality["autoFlee"] = False
        resource_gethering_npc.personality["abortMacrosOnAttack"] = False
        resource_gethering_npc.personality["autoCounterAttack"] = False

        quest = src.quests.questMap["BeUsefull"](strict=True)
        quest.autoSolve = True
        quest.assignToCharacter(resource_gethering_npc)
        quest.activate()
        resource_gethering_npc.assignQuest(quest,active=True)
        resource_gethering_npc.foodPerRound = 1
        resource_gethering_npc.duties.append("resource gathering")
...
"""),])
        ...
        wall_manufacturing_room.addItem(item,(1,6,0))
...
"""),])
        ...
        food_processing_room.addItem(item,(11,6,0))
    ...
    def setUpSternsBase(self,pos):
        ...
        # create spawn room
        ##
        src.magic.spawnSpawnRoom(currentTerrain, (7, 8), faction)

        ####
        # create temple
        ##
        src.magic.spawnTempleRoom(currentTerrain, (7, 6), faction)
        ...
        #
        src.magic.spawnTrapRoom(currentTerrain, (5, 7), faction)
        ...
        farmPlotTiles = []
        fightingSpots = [(1,8,0),(2,10,0),(6,8,0),(9,8,0),(10,6,0),(9,5,0),(7,5,0),(3,8,0),(3,6,0)]
        ...
        snatcherNests = [(4,12,0),(8,3,0),(6,5,0)]
        ...
        for x in range(1,14):
            for y in range(1,14):
                ...
                if random.random() > 0.2:
                    ...
                    bolt.bolted = False
                    currentTerrain.addItem(bolt,pos)
        ...
        for genericEnemyGroupPosition in genericEnemyGroups:
            ...
            for _i in range(0,random.randint(1,2)):
                ...
                quest.activate()
                enemy.quests.append(quest)
                currentTerrain.addCharacter(enemy,genericEnemyGroupPosition[0]*15+random.randint(3,12),genericEnemyGroupPosition[1]*15+random.randint(3,12))
